...
<html lang="en">
  ...
  <body style="background-color:bisque;">
    <h1 class="text-center" style="font-style:italic;">Edit Data Siswa</h1>
            ...
            <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" name="nohandphone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->nohandphone }}">
                  </div>
                  <div class="mb-3">
